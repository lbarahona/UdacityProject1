...
"Group"===a.group_ref.ref&&e(a.group_ref.key)});a.ready=!0})}]);angular.module("overview").directive("nanodegreeEnrollmentActions",["cacheVersion","currentUser","groups","$location","dateTime","$window","gaqHelper","cookieJar","googleTagManager",function(a,d,b,c,e,f,g,h,j){return{restrict:"A",scope:{enrollmentActions:"="},templateUrl:"/templates/overview/nanodegree_enrollment_actions.html?"+a,controller:"enrollmentActionsHelper",link:function(a){var b=function(a){return{nd000:{start:"Feb. 4",end:"Feb. 10 at 11:59 pm Eastern Time"},nd001:{start:"Feb. 4",end:"Feb. 10 at 11:59 pm Eastern Time"},
nd002:{start:"Feb. 4",end:"Feb. 10 at 11:59 pm Eastern Time"},nd003:{start:"Mar. 4 at noon Eastern Time",end:"Mar. 9 at 11:59 pm Eastern Time"},nd004:{start:"Feb. 4",end:"Feb. 10 at 11:59 pm Eastern Time"}}[a]||{}},c=function(){j.pushTrackingEvent("nanodegreeAccess");a._goToClass()};a.getNanodegreeButtonInfo=function(){return a.isAccessible&&(a.isPaidEnrolled||a.isPaidGraduated)?{variant:"nanodegree is live, student is enrolled or graduated",text:"Continue nanodegree",action:c}:a.isPaidEnrollable?
a.isClassFull?a.isPaidWaitlisted?(h.exists("udacity_notify_me_clicked_recently")&&(j.pushTrackingEvent("notificationListJoin"),g.pushTrackingEvent("Waitlist","SignUp",a.courseKey),h.remove("udacity_notify_me_clicked_recently")),{variant:"nanodegree is full, student is waitlisted",statusMessage:"You will be emailed when enrollment opens "+b(a.courseKey).start,statusSuccess:!0}):{variant:"nanodegree is full, student not waitlisted, not enrolled",text:"Notify me",sidenote:"when nanodegree re-opens",
statusMessage:"<strong>Next enrollment opens "+b(a.courseKey).start+".</strong><br>You can start the program immediately after you enroll.",action:function(){h.set("udacity_notify_me_clicked_recently","yes",{expires:new Date((new Date).getTime()+6E5)});a._joinGroup(a.waitlistGroupKey)}}:{variant:"nanodegree live, student not enrolled",text:"Enroll in nanodegree",sidenote:"One week trial",statusMessage:"You can start the program immediately after you enroll. <br><strong>Enrollment closes "+b(a.courseKey).end+
".</strong>",action:function(){j.pushTrackingEvent("nanodegreeEnrollment");a._purchaseCourse()}}:{variant:"nanodegree not open for paid enrollment",sidenote:"This nanodegree is not yet available for enrollment"}};a=_.extend(a,a.enrollmentActions);a.productLaunchDate=new Date(a.productLaunchDateString);a.hasProductLaunched=a.enrollmentActions.isLaunched;a.isVIP=a.isAccessible&&(!a.isAvailable&&!a.isLaunched||a.canEditContent)&&a.getNanodegreeButtonInfo().action!==c;a.isFull=a.isClassFull&&!(a.isPaidInterested||
a.isPaidEnrolled||a.isPaidGraduated)}}}]);angular.module("overview").controller("nanodegreePortal",["$scope","cacheVersion","nodes","$window","currentUser","dateTime","api","$timeout","$q","productState","modal","fetchDiscourseLink",function(a,d,b,c,e,f,g,h,j,k,i,l){var m={};a.submissions={};a.submissionsFetched={};a.launchHangoutOnAir=function(a,b){i.activate(a).finally(function(){var a=$("#"+b),c=a.attr("src");a.attr("src","");a.attr("src",c)})};a.dismiss=function(){i.confirm()};var p=function(b){var b=b||0,c=_.find(a.submissionsFetched,
